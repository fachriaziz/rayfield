...
function RayfieldLibrary:CreateWindow(Settings)
	...
	function Window:CreateTab(Name, Image, Ext)
		...
		function Tab:CreateDropdown(DropdownSettings)
			...
			SearchBoxStroke.Color = SelectedTheme.InputStroke
			...
			local function filterOptions(searchText)
				...
				for _, option in ipairs(Dropdown.List:GetChildren()) do
					if option.ClassName == "Frame" and option.Name ~= "Placeholder" then
						local optionText = string.lower(option.Title.Text)
						if string.find(optionText, searchText, 1, true) then
							option.Visible = true
						else
			...
			local function SetDropdownOptions()
				for _, Option in ipairs(DropdownSettings.Options) do
					...
					-- Move dropdown button/option more to the right to center it
					DropdownOption.Position = UDim2.new(0, 25, 0, 0)
					DropdownOption.Size = UDim2.new(1, -50, 0, 25)
